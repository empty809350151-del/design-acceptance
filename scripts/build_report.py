      ...
      <main><section>
        ...
        <div class="overlay-layout">
          <div class="visual-column">
            <div class="overlay-wrap" data-overlay data-align-offset="{float(page.get('align_offset_percent', 0))}">
              ...
              <svg class="markup" viewBox="0 0 750 1624" aria-label="问题框选层">{issue_svg(issues)}</svg>
            </div>
